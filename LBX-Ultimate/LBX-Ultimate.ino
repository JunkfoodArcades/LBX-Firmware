...
// Like before, values in the code were observed by flashing Crane's GCCPCB2 code to an arduino PCB and observing the values in "Visual Controller Test".
...
// /needs testing/ Change to 2ip reactivate
// /Done/ Remove special array 5 - not needed
// /Done/ Make sure B affects all directions and all angles
// /Done/ Clean up empty spaces in arrays
...
// Define ModX and ModY impact on single cardinal directions in 2 arrays. (see spreadsheet tabs 3 & 4)
int modXArr[4] = {177,79,88,168}; // Mod X
int modYArr[4] = {179,77,101,155}; // Mod Y

// Define angle values in 4 arrays. (see spreadsheet tabs 1 & 2)
int angleArr1[17] = {102,79,79,67,86,62,93,57,101,203,28,28,28,77,77,60,79};                       // Down
int angleArr2[17] = {88,90,67,79,62,86,57,93,53,101,28,28,28,77,77,88,90};                         // Left
int angleArr3[17] = {154,177,177,189,170,194,163,199,155,203,228,228,228,179,179,196,177};         // UP
int angleArr4[17] = {168,166,189,177,194,170,199,163,203,155,228,228,228,179,179,168,166};         // Right
...
void scrubDirSOCD() {
  ...
  //Check left and right
    ...
    if(prevIntLeftRight>0 && intLeftRight==3){intLeftRight = (intLeftRight ^ prevIntLeftRight);} // SOCD, 2ip no reactivate. Can't subtract a larger number from a smaller number and stil have a positive int. Do a bit comparison using XOR instead.
  }
  ...
  //Check up and down
    ...
    if(prevIntUpDown>0 && intUpDown==3){intUpDown = (intUpDown ^ prevIntUpDown);} // SOCD, 2ip no reactivate. Can't subtract a larger number from a smaller number and stil have a positive int. Do a bit comparison using XOR instead.
  }
}
...
void scrubAngles() {
  ...
  switch (intDirs) {
      ...
      case 4:
        ...
        else if((intMods==2) && (boolB)){axisY=specialArr4[1];}                         // Down and ModY+B
        break;      
      ...
      case 5:
        ...
        else if((intMods==2) && (boolB)){axisY=angleArr1[16];axisX=angleArr2[16];}                                  // Down Left and ModY+B
        break;
      ...
      case 6: 
        ...
        else if((intMods==2) && (boolB)){axisY=angleArr1[16];axisX=angleArr4[16];}                                  // Down Right and ModY+B
        break;    
      ...
      case 8:
        ...
        else if((intMods==2) && (boolB)){axisY=specialArr4[0];}                         // Up and ModY+B
        break;
      ...
      case 9: 
        ...
        else if((intMods==2) && (boolB)){axisY=angleArr3[16];axisX=angleArr2[16];}                                  // Up Left and ModY+B
        break;
      ...
      case 10:
        ...
        else if((intMods==2) && (boolB)){axisY=angleArr3[16];axisX=angleArr4[16];}                                  // Up Right and ModY+B
        break;
  }
}
